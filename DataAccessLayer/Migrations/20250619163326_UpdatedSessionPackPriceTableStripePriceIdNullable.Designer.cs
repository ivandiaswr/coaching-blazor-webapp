...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250619163326_UpdatedSessionPackPriceTableStripePriceIdNullable")]
    partial class UpdatedSessionPackPriceTableStripePriceIdNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelLayer.Models.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ModelLayer.Models.Session", b =>
                {
                    ...
                    b.Property<bool>("IsSessionBooking")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ModelLayer.Models.SessionPack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ModelLayer.Models.SessionPackPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ModelLayer.Models.SubscriptionPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal?>("PriceConverted")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ModelLayer.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ModelLayer.Models.SessionPack", b =>
                {
                    b.HasOne("ModelLayer.Models.SessionPackPrice", "Price")
                        .WithMany()
            ...
            modelBuilder.Entity("ModelLayer.Models.UserSubscription", b =>
                {
                    b.HasOne("ModelLayer.Models.SubscriptionPrice", "Price")
                        .WithMany()
                        .HasForeignKey("PriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
